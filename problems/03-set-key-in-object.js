...
***********************************************************************/
//Understand
  //function named setKeyInObject
    //accepts an object (obj), a string (string), and a value(value)
  //return the object, adding the string as a key, using the value given

//Plan
//assign using square bracket notation
